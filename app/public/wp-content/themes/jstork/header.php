...
<![endif]-->
    ...
    <?php wp_head(); ?>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/library/css/custom.css" type="text/css" />
</head>
            ...
            <div id="top-header" class="cf">
                <div class="top-header-sns">
                    <ul>
                        <li>
                            <a href="">
                                <?php the_image('logo-tw@2x.png', 'profile', 'ツイッター', 16, 13); ?>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <?php the_image('logo-fb@2x.png', 'profile', 'フェイスブック', 16, 16); ?>
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <?php the_image('logo-ist@2x.png', 'profile', 'インスタグラム', 16, 16); ?>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="top-header-copy">
                    <ul>
                        <li>
                            <a href="http://www.greeniche.jp/" target="_blank">
                                <?php the_image('puroduceby1@2x.png', 'profile', 'グリニッチproduceエラヴァニ', 170, 23); ?>
                            </a>
                        </li>
                        <li>
                            <a href="http://fdbmobler.jp/" target="_blank">
                                <?php the_image('puroduceby2@2x.png', 'profile', 'sponsored by FDBモブラー', 113, 23); ?>
                            </a>
                        </li>
                    </ul>
                </div>
...
<!--                <a href="#searchbox" data-remodal-target="searchbox" class="nav_btn search_btn"><span class="text gf">search</span></a>-->
     ...
     'fallback_cb' => ''
        ...
        <div class="header-info <?php echo esc_html(get_option('side_options_headerbg'));?>">
            <a<?php if(get_option( 'other_options_headerunderlink_target')):?> target="_blank"
                <?php endif;?> href="
                <?php echo esc_html(get_option('other_options_headerunderlink'));?>">
                <?php echo esc_html(get_option('other_options_headerundertext'));?>
                </a>
        </div>
        <?php endif;?>
